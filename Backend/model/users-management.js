...
function addGameInCollection(game, callback) {
    ...
    DB.pool.query(
        `INSERT INTO games VALUES(null, '${game.gameName}', '${game.description}', ${game.minAge}, ${game.minNbPlayer}, ${game.maxNbPlayer}, ${game.duration}, ${game.creationDate}, ${game.idUser});`,
        (err, result) => {
            callback(err, result);
        }
    );
