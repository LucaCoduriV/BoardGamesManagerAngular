...
//survey
router.post(
	'/users/:idUser/surveys/:idSurvey/candidates/:idCandidate/vote',
	surveysCtrl.vote
); //OK
...
router.get(
	'/users/:idUser/games/:idGames',
	jwt.verifyToken,
	usersCtrl.getGameInfoCollection
); //OK

router.post(
	'/users/:idUser/games',
	jwt.verifyToken,
	usersCtrl.addGameInCollection
); // OK
router.put(
	'/users/:idUser/games/:idGame',
	jwt.verifyToken,
	usersCtrl.modifyGameInCollection
); // OK
router.delete(
	'/users/:idUser/games/:idGame',
	jwt.verifyToken,
...
router.post(
	'/users/:idUser/surveys',
	jwt.verifyToken,
	surveysCtrl.createSurvey
); //ok
router.delete(
	'/users/:idUser/surveys/:idSurvey',
	jwt.verifyToken,
	surveysCtrl.deleteSurvey
); //ok
